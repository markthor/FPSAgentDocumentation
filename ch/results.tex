...
%\input{graph/nolight-vpr.tex} %DONE
%\input{graph/light-vpr.tex} %DONE

%\input{graph/angular-mse.tex}
\input{graph/angular-acc.tex} %NEEDS CORRECT DATA
\input{graph/angular-mse-nolight-deep.tex} %NEEDS CORRECT DATA
\input{graph/angular-mse-nolight-shallow.tex} %NEEDS CORRECT DATA
\input{graph/angular-mse-light-deep.tex} %NEEDS CORRECT DATA
\input{graph/angular-mse-light-shallow.tex} %NEEDS CORRECT DATA