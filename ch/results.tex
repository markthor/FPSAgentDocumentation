...
% NEAT GRAPHS
\input{graph/neat/neat-overall-fitness.tex} %DONE
\input{graph/neat/neat-aiming-fitness.tex} %DONE
\input{graph/neat/neat-shooting-fitness.tex} %DONE

\input{graph/neat/neat-angular-fitness.tex} %DONE
\input{graph/neat/neat-angular-recoil-fitness.tex} %DONE
\input{graph/neat/neat-vpr-fitness.tex} %DONE
\input{graph/neat/neat-vpr-recoil-fitness.tex} %DONE
