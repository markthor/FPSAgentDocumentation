...
\begin{figure}[H]
	...
	\end{scriptsize}
	\caption[Difficult VPR classification example]{The deep CNN estimating the VPR correctly predicts the class with a confidence of 55.7\%, with only four pixels of the target being visible.}
