...
\begin{tikzpicture}[scale=1]
	...
	\end{axis}
\end{tikzpicture}
\caption[Training the VRC using AR with visual distortion]{Mean squared error cost over mini-batch gradient descent iterations using AR with visual distortion}
