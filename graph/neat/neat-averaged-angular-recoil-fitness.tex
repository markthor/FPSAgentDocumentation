...
\begin{tikzpicture}[scale=1]
	...
	\end{axis}
\end{tikzpicture}
\caption[Averaged fitness with recoil for the AR]{The total shooting and aiming fitness averaged with recoil for the AR. Each graph is an average of 3 runs.}
\label{fig:neat-averaged-angular-recoil-fitness}
\end{figure}