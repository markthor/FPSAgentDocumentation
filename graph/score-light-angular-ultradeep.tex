...
\begin{tikzpicture}[scale=1]
	\begin{axis}[
		...
		\addlegendentry{Deeper network}
	\end{axis}
\end{tikzpicture}
\caption[Training the deeper VRC using AR with visual distortion]{Mean squared error cost over mini-batch gradient descent iterations using AR with visual distortion}
