...
\end{tikzpicture}
\caption[Mean error of the deeper network]{Mean absolute error of the deeper topology compared to the deep topology with visual distortion, evaluated on a test set.}
